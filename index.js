...
async function Question() {
    const data = await inquirer.prompt([
        ...
        },
        {
            name: "question1",
            type: "list",
            message: " An e-mail that appears to originate from one source but actually has been sent from another?",
    ...
    if (question1 === "Spoofing" &&
        question2 === "Spam" &&
        question3 === "debugging") {
        console.log(`You passed the quiz ${chalk.bgCyanBright("Congratulations !")}`);
    }
    else {
